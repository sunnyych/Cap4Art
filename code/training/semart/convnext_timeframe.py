...
wandb.init(
    project="convnext-semart-type-finetune",
    config={
        "epochs": 30,
        "batch_size": 32,
        "lr": 3e-4,
...
training_csv = "semart_train_clean.csv"
val_csv = "semart_val_clean.csv"
test_csv = "semart_test_clean.csv"
training = pd.read_csv(training_csv)
val = pd.read_csv(val_csv)
test = pd.read_csv(test_csv)

TIME_LIST = ['1501-1550', '1751-1800', '1601-1650', '1451-1500', '1801-1850', '1401-1450', '1301-1350', '1551-1600', '1651-1700', '1851-1900', '1251-1300', '1351-1400', '1701-1750', '1101-1150', '1151-1200', '0801-0850', '1201-1250', '0851-0900', '1051-1100', '1001-1050', '0751-0800', '0951-1000']

EMOTION2IDX = {emotion: idx for idx, emotion in enumerate(TIME_LIST)}

# class_counts = training['TIMEFRAME'].value_counts().reindex(TIME_LIST).fillna(0).values
# total_samples = class_counts.sum()
# class_weights = total_samples / (len(TIME_LIST) * class_counts)
...
class PaintingEmotionDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        try:
            ...
            # print(f"Error loading image {row['IMAGE_FILE']}: {e}")
            image = Image.new('RGB', (224, 224), (0, 0, 0))

        image = self.transform(image)
        label = EMOTION2IDX[row['TIMEFRAME']]
        return image, label
...
train_dataset = PaintingEmotionDataset(training, train_transform)
val_dataset = PaintingEmotionDataset(val, val_test_transform)
test_dataset = PaintingEmotionDataset(test, val_test_transform)
...
trained_model_dir = "./trained_semart_timeframe"
...
for img_path in tqdm(test_image_paths, desc="Classifying test images"):
    ...
    with torch.no_grad():
        ...
        pred_label = TIME_LIST[pred_class_idx]
...
df_preds.to_csv("semart_timeframe.csv", index=False)
